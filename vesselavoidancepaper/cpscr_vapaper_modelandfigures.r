...
plot(dat$fig11.2[1,],dat$fig11.2[2,],xlim=c(-10,40),ylim=c(100,150),type="l",xlab="time (s)",ylab=expression(paste("SPL (dB re 1",mu,"Pa)")))
lines(dat$fig11.1[1,],dat$fig11.1[2,],'col'=gray(.8))
mtext("(a)",side=3,line=0,adj=0)

plot(dat$fig12.2[1,],dat$fig12.2[2,],xlim=c(-10,40),ylim=c(100,150),type="l",xlab="time (s)",ylab="")
lines(dat$fig12.1[1,],dat$fig12.1[2,],'col'=gray(.8))
mtext("(b)",side=3,line=0,adj=0)
plot(dat$fig13.2[1,],dat$fig13.2[2,],xlim=c(-10,40),ylim=c(100,150),type="l",xlab="time (s)",ylab="")
mtext("(c)",side=3,line=0,adj=0)
lines(dat$fig13.1[1,],dat$fig13.1[2,],'col'=gray(.8))
...
plot(dat$fig31.2[1,],dat$fig31.2[2,],ylim=c(40,140),type="l",xlab="frequency (Hz)",ylab=expression(paste("PSD (dB re 1",mu,"P",a^2," H",z^-1,")")))
lines(dat$fig31.1[1,],dat$fig31.1[2,],'col'=gray(.8))
mtext("(g)",side=3,line=0,adj=0)
plot(dat$fig32.2[1,],dat$fig32.2[2,],ylim=c(40,140),type="l",xlab="frequency (Hz)",ylab="")
lines(dat$fig32.1[1,],dat$fig32.1[2,],'col'=gray(.8))
mtext("(h)",side=3,line=0,adj=0)
plot(dat$fig33.2[1,],dat$fig33.2[2,],ylim=c(40,140),type="l",xlab="frequency (Hz)",ylab="")
lines(dat$fig33.1[1,],dat$fig33.1[2,],'col'=gray(.8))
