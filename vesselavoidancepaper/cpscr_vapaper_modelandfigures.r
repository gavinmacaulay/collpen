...
plot(dat$fig11[1,],dat$fig11[2,],xlim=c(-10,40),ylim=c(110,150),type="l",xlab="time (s)",ylab=expression(paste("SPL (dB re 1",mu,"Pa)")))
mtext("(a)",side=3,line=0,adj=0)
plot(dat$fig12[1,],dat$fig12[2,],xlim=c(-10,40),ylim=c(110,150),type="l",xlab="time (s)",ylab="")
mtext("(b)",side=3,line=0,adj=0)
plot(dat$fig13[1,],dat$fig13[2,],xlim=c(-10,40),ylim=c(110,150),type="l",xlab="time (s)",ylab="")
mtext("(c)",side=3,line=0,adj=0)

plot(dat$fig21[1,]/1000,dat$fig21[2,],xlim=c(-10,40),ylim=c(-50,50),type="l",xlab="time (ms)",ylab="Pressure (Pa)")
mtext("(d)",side=3,line=0,adj=0)
plot(dat$fig22[1,]/1000,dat$fig22[2,],xlim=c(-10,40),ylim=c(-50,50),type="l",xlab="time (ms)",ylab="")
mtext("(e)",side=3,line=0,adj=0)
plot(dat$fig23[1,]/1000,dat$fig23[2,],xlim=c(-10,40),ylim=c(-50,50),type="l",xlab="time (ms)",ylab="")
