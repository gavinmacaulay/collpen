    ...
    )
{
	...
	transformee    = (double *) mymxGetPr(IN_4);
	...
	taille_y_e =  &y_size;
        ...
        jp2_code    = (unsigned char *) mymxGetPr(IN_1);
	...
	matlab_ex_data = (void*) mymxGetPr(OUT_2);
	#endif

        /* Assign pointers to the output parameters */
        rgb_image 	= 	(void *) mymxGetPr(OUT_1);
	...
	/* Create a matrix for the return argument */
        ...
        /* Assign pointers to the output parameters */
		jp2_code    = (unsigned char *) mymxGetPr(OUT_1);
