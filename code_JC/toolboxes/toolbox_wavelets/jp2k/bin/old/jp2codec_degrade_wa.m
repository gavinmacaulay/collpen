function [result_dble] = jp2codec_degrade_wa(Isrc, comp_ratio, bit_depth, Isrc_dble,  mean_low_level, low_level_dimx)
%
...
[comp_data] = jp2_codec_wa(MakePlainImage(I_cropped), target_size, bit_depth, transpose(Isrc_dble), mean_low_level, low_level_dimx);
[decoded,result_dble] = jp2_codec_wa(comp_data, 0, 0, 0,  mean_low_level, low_level_dimx);
