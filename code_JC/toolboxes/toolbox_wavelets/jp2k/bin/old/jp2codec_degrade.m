function [result_dble] = jp2codec_degrade_ba(Isrc, comp_ratio, bit_depth, Isrc_dble, mean_low_level, pixel_low_level)
%
...
[comp_data] = jp2_codec(MakePlainImage(I_cropped), target_size, bit_depth, Isrc_dble, mean_low_level, pixel_low_level);
[decoded,result_dble] = jp2_codec(comp_data, 0, 0, 0, mean_low_level, pixel_low_level);
