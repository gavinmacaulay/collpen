...
% cartesian_video = 'block5_1_396_514_Raw_1825_1920_raw_cartesian.avi';
% polar_video = 'block5_1_396_514_Raw_1825_1920_raw_polar.avi';
% map_scan = 'block5_1_396_514_Raw_1825_1920_map_scan.mat';
%
...
source_folder       = '/Volumes/Datos/collpen/methods_paper_sources/';
cartesian_video     = 'block5_1_Raw_396_514_raw_cartesian.avi';
polar_video         = 'block5_1_Raw_396_514_raw_polar.avi';
aris_cartesian_video = 'block5_1_396_514_aris_cartesian.avi';
aris_polar_video    = 'block5_1_396_514_aris_polar.avi';
polar_video_wide    = 'block5_1_Raw_396_514_raw_polarwide.avi';
...
disp([num2str(n) ' frames in the video sequence']);
% 
...
for i=1:n
    ...
    = aris_match_raw_cartesian_to_sfw_and_polar(cart_point)
...
%     aris_cart_point = homography_transform(cart_point',v3);
    ...
    aris_cart_point = aris_raw_cart_to_cart_arissfw_point(cart_point);
    plot(round(aris_cart_point(1)),round(aris_cart_point(2)),'xg');
...
%     angle = alpha * c2/28;
    ...
    beam = get_aris_beam_from_angle(alpha);
    range = round(r2 - (c*r2/r1) + r2*(image_h-r1)/r1);
    

    rad2deg(atan(-96/364))
    rad2deg(atan(149/562))
    rad2deg(atan(102/588))
    ...
    plot(round(beam),round(range),'xg');
    hold off
    ...
    plot(round(beam*6),round(range),'xg');
    hold off;
    ...
    aris_polar = aris_raw_polar_to_polar_arissfw_point([beam,range]);
