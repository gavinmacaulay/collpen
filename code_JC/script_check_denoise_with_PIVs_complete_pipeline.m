    ...
    if(~isempty(PIV_winsize(j)))
        ...
        for i = 1:length(denoising_techniques_name)
            if(~isempty(denoising_techniques_name{i}))
                [dot_product_acc, angle_acc, range_acc, relative_range_acc] = ...
                ...
                fprintf(fileID,'%s\t%f\t%f\t%f\t%f\n',...
                    ...
                    median_angle, median_range, median_relative_range);
            end
        end
        fprintf(fileID,'\n\n');
    end
...
'accumulated_dot_product','accumulated_relative_range','accumulated_denoising_name');
