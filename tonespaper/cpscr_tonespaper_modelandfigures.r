setwd('/repositories/CollPen_mercurial/tonespaper')
...
boxplot(T2$v_score ~ T2$b_groupsize,,xlab="Group size",ylab="Score",axes=F)
axis(1,at=c(1,2),labels=c("Large","Small"))
axis(2)
